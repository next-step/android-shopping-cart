        ...
        Row(
            ...
            IconButton(
                ...
                Icon(
                    ...
                    contentDescription = "${item.name} ${stringResource(R.string.cart_list_item_remove)}"
                )
            }
        }
        Row(
            ...
            Column(
                ...
                Text(
                    ...
                    text = stringResource(R.string.product_price_format, item.price),
                ...
                QuantityHandler(
                    ...
                    onIncreaseQuantityClick = {
                        onIncreaseQuantityClick(item)
                    },
                    onDecreaseQuantityClick = {
                        onDecreaseQuantityClick(item)
                    },
                )
            }
        }
